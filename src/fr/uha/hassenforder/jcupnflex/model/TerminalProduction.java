...
public class TerminalProduction extends Production {
	...
	private final TerminalKind sub;
	 ...
	 *
	 */
	public TerminalProduction(Terminal lhs, TerminalKind sub, String inState, String regexp, String enterState, String code) {
		super(ProductionKind.TERMINAL);
		this.lhs = lhs;
		this.sub = sub;
	...
	public String getRegion() {
		return inState;
//		if (sub == TerminalKind.SIMPLE) return "";
